...
program
  ...
  .option('-t, --title <value>','Specify the page title').preset('Embed Viewer')
  ...
  .option('-e, --excludes <value>','Specify folder that will excluded during the process of scanning').preset('node_modules')
